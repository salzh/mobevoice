...
class Curl_Client
{
    ...
    private function request($request_url, $redirect_flag = false)
    {
        ...
        if ($request_url == '') {
            ...
            $host = $url_info['host'];
            $basic_user = isset($url_info['user']) ? $url_info['user'] : "";
            $basic_pass = isset($url_info['pass']) ? $url_info['pass'] : "";
    ...
    public function getUrlInfo($place = '')
    {
    ...
    private function setOptionsHeaders()
    {
        ...
        $this->_options[CURLOPT_HTTPHEADER] = $final;
    }
